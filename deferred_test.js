...
(function() {
  var _, assert, assertHasPromiseApi, assertIsPromise, deferred, expectedMethods,
    slice = [].slice;
  ...
  assertHasPromiseApi = function(promise) {
    var j, len, method, results;
    results = [];
    for (j = 0, len = expectedMethods.length; j < len; j++) {
      method = expectedMethods[j];
      results.push(assert(_.has(promise, method)));
    }
    return results;
  };
  ...
  describe('deferred', function() {
    ...
    describe('promises', function() {
      ...
      return describe('when', function() {
        ...
        it('should pass objects through', function() {
          var value;
          value = {};
          return deferred.when(value).done(function(deferredValue) {
            return assert.strictEqual(value, deferredValue);
          });
        });
        return it('should pass arrays through', function() {
          var value;
          value = [];
          return deferred.when(value).done(function(deferredValue) {
            return assert.strictEqual(value, deferredValue);
